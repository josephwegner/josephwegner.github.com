...
tags:
  ...
  - "WhyNodeJS"
---
Welcome to part two of the <strong><a title="Why Node.JS? Series" href="https://joewegner.com/tag/whynodejs/">Why Node.JS?</a> </strong>series.  If you recall from my last post, I'm currently in the middle of porting <a title="File Drop" href="https://joewegner.com/file-drop/">fileDrop</a> from PHP to Node.JS.  This is a three part series, consisting of my three main reasons for porting: <strong><a title="Node.JS Speed" href="https://joewegner.com/blog/why-node-js-speed/">Speed</a></strong>, <strong>Security</strong>, and <strong>Portability</strong>.  This week I will be talking about the amazing security options that come with Node.JS.  Here's the crazy part, though - even though security is one of my biggest reasons for porting to Node.JS, <em>it isn't actually a feature of Node.JS.</em> Read exactly how this works after the break.
